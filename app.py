...
def main():
    ...
    while True:
        ...
        if (len(bezier_ctrl_points)) == 4:
            debug_image = draw_bezier_curve(debug_image, bezier_ctrl_points, 500)
...
def compute_bezier_point(u, point, n_ctrl_pts, ctrl_pts, coeffs):
    ...
    for k in range(n_ctrl_pts):
        ...
        point.x += ctrl_pts[k][0] * bez_blend_fcn  # Access x using index 0
        point.y += ctrl_pts[k][1] * bez_blend_fcn  # Access y using index 1
